...
<div data-role="page">
	...
	<div data-role="footer" data-id="samebar" class="nav-glyphish-example" data-position="fixed" data-tap-toggle="false">
		...
		<ul>
			...
			<li><a href="global.php" id="global" data-icon="custom" class="ui-btn-active">Global</a></li>
			<li><a href="add.php" id="add" data-icon="custom">Filter</a></li>
